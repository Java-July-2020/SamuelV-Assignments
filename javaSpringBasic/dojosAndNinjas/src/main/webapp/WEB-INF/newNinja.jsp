...
<body>
	...
	<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/dojos/new">Add New Dojo</a>
                </li> 
            </ul>
        </div>
	...
	<main class="mt-3">
	 	<h2 class="mb-3">New Ninja</h2>
		<form:form action="/ninjas/new" method="POST" modelAttribute="ninja">
		    <!-- Person Field -->
		    <div class="form-group row mx-0">
		        <form:label class="col-sm-1 col-form-label" path="dojo">Dojo</form:label>
		        <div class="col-sm-3">
		        	...
		        	<form:errors class="small" path="dojo"/>
		        </div>
		    </div>
		    ...
		    <!-- Age Field -->
		    <div class="form-group row mx-0">
		        <form:label class="col-sm-1 col-form-label" path="age">Age</form:label>
		        <div class="col-sm-3">
		        	<form:input class="form-control" type="text" path="age"/>
		        	<form:errors class="small" path="age"/>
		        </div>
		    </div>
