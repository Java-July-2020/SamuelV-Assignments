...
<body>
	...
	<main class="mt-3">
		...
		<p class="mt-2"> 
			<a class = "btn btn-secondary text-decoration-none" href="/songs/edit/${song.id}">Edit Song</a> 
			<a class = "btn btn-danger text-decoration-none ml-2" href="/songs/delete/${song.id}">Delete Song</a> 
		</p>
