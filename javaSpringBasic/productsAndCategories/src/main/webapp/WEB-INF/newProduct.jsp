...
<body>
	...
	<main class="mt-3">
		...
		<form:form action="/products/new" method="POST" modelAttribute="product">
		    ...
		    <!-- Description Field -->
		    <div class="form-group row mx-0">
		        <form:label class="col-1 col-form-label" path="description">Description</form:label>
		        <div class="col-3">
		    ...
		    <!-- Price Field -->
		    <div class="form-group row mx-0">
		        <form:label class="col-1 col-form-label" path="price">Price</form:label>
		        <div class="col-3">
		        	<form:input class="form-control" type="decimal" path="price"/>
		        	<form:errors class="small" path="price"/>
		        </div>
		    </div>
